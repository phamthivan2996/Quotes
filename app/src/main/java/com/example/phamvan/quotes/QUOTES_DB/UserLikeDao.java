...
public class UserLikeDao extends AbstractDao<UserLike, Long> {
    ...
    /**
     * Properties of entity UserLike.<br/>
    ...
    public UserLikeDao(DaoConfig config) {
        super(config);
    }
    
    public UserLikeDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER_LIKE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"USER_LIKE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, UserLike entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, UserLike entity) {
        stmt.clearBindings();
    ...
    @Override
    public UserLike readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, UserLike entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(UserLike entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(UserLike entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(UserLike entity) {
