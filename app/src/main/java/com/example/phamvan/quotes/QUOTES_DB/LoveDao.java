 ...
 * DAO for table "LOVE".
*/
public class LoveDao extends AbstractDao<Love, Long> {

    public static final String TABLENAME = "LOVE";

    /**
     * Properties of entity Love.<br/>
    ...
    public LoveDao(DaoConfig config) {
        super(config);
    }
    
    public LoveDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"LOVE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"LOVE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Love entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Love entity) {
        stmt.clearBindings();
    ...
    @Override
    public Love readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, Love entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Love entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Love entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Love entity) {
