...
/** 
 * DAO for table "HAPPINESS".
*/
public class HappinessDao extends AbstractDao<Happiness, Long> {

    public static final String TABLENAME = "HAPPINESS";

    /**
     * Properties of entity Happiness.<br/>
    ...
    public HappinessDao(DaoConfig config) {
        super(config);
    }
    
    public HappinessDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"HAPPINESS\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"HAPPINESS\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Happiness entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Happiness entity) {
        stmt.clearBindings();
    ...
    @Override
    public Happiness readEntity(Cursor cursor, int offset) {
        Happiness entity = new Happiness( //
    ...
    @Override
    public void readEntity(Cursor cursor, Happiness entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Happiness entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Happiness entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Happiness entity) {
