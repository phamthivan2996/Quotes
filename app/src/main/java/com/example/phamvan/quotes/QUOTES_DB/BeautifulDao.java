...
/** 
 * DAO for table "BEAUTIFUL".
*/
public class BeautifulDao extends AbstractDao<Beautiful, Long> {

    public static final String TABLENAME = "BEAUTIFUL";

    /**
     * Properties of entity Beautiful.<br/>
    ...
    public BeautifulDao(DaoConfig config) {
        super(config);
    }
    
    public BeautifulDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BEAUTIFUL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BEAUTIFUL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Beautiful entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Beautiful entity) {
        stmt.clearBindings();
    ...
    @Override
    public Beautiful readEntity(Cursor cursor, int offset) {
        Beautiful entity = new Beautiful( //
    ...
    @Override
    public void readEntity(Cursor cursor, Beautiful entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Beautiful entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Beautiful entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Beautiful entity) {
