...
/** 
 * DAO for table "HEART_SPIRIT".
*/
public class HeartSpiritDao extends AbstractDao<HeartSpirit, Long> {

    public static final String TABLENAME = "HEART_SPIRIT";

    /**
     * Properties of entity HeartSpirit.<br/>
    ...
    public HeartSpiritDao(DaoConfig config) {
        super(config);
    }
    
    public HeartSpiritDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"HEART_SPIRIT\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"HEART_SPIRIT\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, HeartSpirit entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, HeartSpirit entity) {
        stmt.clearBindings();
    ...
    @Override
    public HeartSpirit readEntity(Cursor cursor, int offset) {
        HeartSpirit entity = new HeartSpirit( //
    ...
    @Override
    public void readEntity(Cursor cursor, HeartSpirit entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(HeartSpirit entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(HeartSpirit entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(HeartSpirit entity) {
